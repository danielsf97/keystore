...
import keystore.tpc.Coordinator2;
...
public class Server2 extends Serv {
    ...
    private Coordinator2 coordinator;
    ...
    private Server2() {
        ...
        coordinator = new Coordinator2<Map<Long,byte[]>>(addresses,ms,whenDone,"Server",es);
