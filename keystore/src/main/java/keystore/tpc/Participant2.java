...
public class Participant2<T> {
    ...
    private Consumer<T> prepare;
    private Consumer<T> commit;
    private Consumer<T> abort;

    public Participant2(int id, ManagedMessagingService ms, ExecutorService es, String name, Consumer<T> prepare, Consumer<T> commit, Consumer<T> abort) {
